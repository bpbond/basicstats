...
The best-fit slope for the `A` group is **`r round(sm2[2, 1], 3)`**. 

The slope for the `B` group is `r round(sm3[2, 1], 3)` + `r round(sm3[3, 1], 3)` = **`r round(sm3[2, 1] + sm3[3, 1], 3)`**. This is significantly different from the `A` group, because the p-value for `x:groupB` is **`r sm2[3, 4]`**.
