...
* the _p-value_. Here it is 0.079, which traditionally would be interpreted as _no or weak evidence_ against the null hypothesis (because our significance level--see above--was by default 0.05).
